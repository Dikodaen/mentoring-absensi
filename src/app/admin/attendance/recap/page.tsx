...
// Duplicated logic from employee recap for admin context
    ...
    return (
        <DashboardLayout>
            <div className="w-full space-y-4">
                <Link href="/admin/attendance" className="inline-flex items-center text-slate-400 hover:text-slate-600 mb-4 transition-colors">
                    <ArrowLeft className="w-4 h-4 mr-2" />
                    Kembali ke Dashboard
                </Link>

                <Card className="w-full p-8 border-none shadow-sm">
                    <div className="mb-8">
                        <h1 className="text-2xl font-bold text-slate-900">Rekap Kehadiran Bulanan</h1>
                        <p className="text-sm text-slate-500">Admin User - Staff IT</p>
                    </div>
                    ...
                    <div>
                        <h3 className="font-semibold mb-6">Detail Kehadiran</h3>
                        <Table>
                            <TableHeader>
                                <TableRow>
